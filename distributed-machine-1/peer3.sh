...
export CORE_PEER_ADDRESS=192.168.108.71:7055
export CORE_PEER_LISTENADDRESS=192.168.108.71:7055
export CORE_PEER_CHAINCODEADDRESS="${CCADDR}":7056
export CORE_PEER_CHAINCODELISTENADDRESS=192.168.108.71:7056
# bootstrap peer is the other peer in the same org
export CORE_PEER_GOSSIP_BOOTSTRAP=192.168.108.71:7057
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=192.168.108.71:7055
...
export CORE_OPERATIONS_LISTENADDRESS=192.168.108.71:8448
...
# export CORE_LEDGER_STATE_COUCHDBCONFIG_COUCHDBADDRESS=192.168.108.71:5986
